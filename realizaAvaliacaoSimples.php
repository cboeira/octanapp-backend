...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$sqlRetornaCNPJ = $conn->prepare("SELECT cnpj FROM posto WHERE id_posto = $id_posto");
	$sqlRetornaCNPJ->execute();
	$sqlRetornaCNPJ->bind_result($result);

	while ($sqlRetornaCNPJ->fetch()) {
		$cnpj = $result;
	}
